...
const DeleteButton = ({id_producto, successCallback}) => {
    ...
    const eliminarProducto = async (productoID) => {
        ...
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/people/${productoID}`);
    ...
    return (
        <button className="btn btn-secondary ms-2" onClick={() => { confirmarEliminar(id_producto) }}>Eliminar</button>
    )
}
